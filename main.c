...
const float theta_offset = 0.9;
const float YZERO = 0.001;

const float k[4] = {        0,         38.65,     0.21999,   6.1914};
const float Ao[2][2] = {{        0.73439,     -0.037941},{   0.024233,  0.67375}};
const float Bo[2] = {       -0.36957,    0.011097};
const float L1[2][2] = {{       58.909,     -6.1118},{ -10.291,    163.49}};
const float L2[2][2] = {{        -58.909,        6.0754},{  10.291,     -163.48}};  
